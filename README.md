...
[![Go Report Card](https://goreportcard.com/badge/github.com/schmiddim/blackbox-operator)](https://goreportcard.com/report/github.com/schmiddim/blackbox-operator)
...
```sh
make docker-build docker-push IMG=<some-registry>/blackbox-operator:tag
```
...
```sh
make deploy IMG=<some-registry>/blackbox-operator:tag
```
...
```sh
make build-installer IMG=<some-registry>/blackbox-operator:tag
```
...
```sh
kubectl apply -f https://raw.githubusercontent.com/<org>/blackbox-operator/<tag or branch>/dist/install.yaml
```
