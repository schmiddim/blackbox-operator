...
// +kubebuilder:rbac:groups=networking.example.com,resources=serviceentries,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=networking.example.com,resources=serviceentries/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=networking.example.com,resources=serviceentries/finalizers,verbs=update
